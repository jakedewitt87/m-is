...
class ContactGroupAssignDefinition extends BaseDefinition
{
    ...
    public static $fields = array (
        ...
        'Contact.CustomDate1'        => array (
            'access' => array ('Read'),
            'type'   => 'DateTime'
        ),
        'Contact.CustomDate2'        => array (
            'access' => array ('Read'),
            'type'   => 'DateTime'
        ),
        'Contact.CustomDate3'        => array (
            'access' => array ('Read'),
            'type'   => 'DateTime'
        ),
        'Contact.CustomDate4'        => array (
            'access' => array ('Read'),
            'type'   => 'DateTime'
        ),
        'Contact.CustomDate5'        => array (
            'access' => array ('Read'),
            'type'   => 'DateTime'
        ),
        'Contact.CustomDbl1'         => array (
            'access' => array ('Read'),
            'type'   => 'Double'
        ),
        'Contact.CustomDbl2'         => array (
            'access' => array ('Read'),
            'type'   => 'Double'
        ),
        'Contact.CustomDbl3'         => array (
            'access' => array ('Read'),
            'type'   => 'Double'
        ),
        'Contact.CustomDbl4'         => array (
            'access' => array ('Read'),
            'type'   => 'Double'
        ),
        'Contact.CustomDbl5'         => array (
            'access' => array ('Read'),
            'type'   => 'Double'
        ),
        'Contact.CustomField1'       => array (
            'access' => array ('Read'),
            'type'   => 'String'
        ),
        'Contact.CustomField10'      => array (
            'access' => array ('Read'),
            'type'   => 'String'
        ),
        'Contact.CustomField2'       => array (
            'access' => array ('Read'),
            'type'   => 'String'
        ),
        'Contact.CustomField3'       => array (
            'access' => array ('Read'),
            'type'   => 'String'
        ),
        'Contact.CustomField4'       => array (
            'access' => array ('Read'),
            'type'   => 'String'
        ),
        'Contact.CustomField5'       => array (
            'access' => array ('Read'),
            'type'   => 'String'
        ),
        'Contact.CustomField6'       => array (
            'access' => array ('Read'),
            'type'   => 'String'
        ),
        'Contact.CustomField7'       => array (
            'access' => array ('Read'),
            'type'   => 'String'
        ),
        'Contact.CustomField8'       => array (
            'access' => array ('Read'),
            'type'   => 'String'
        ),
        'Contact.CustomField9'       => array (
            'access' => array ('Read'),
            'type'   => 'String'
        ),
